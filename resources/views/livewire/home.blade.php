...
<div>
    ...
    <div class="space-y-5">
        <div class="bg-base-50 grid lg:grid-cols-5 gap-5">
            ...
            <x-stat title="On Progress" value="23" icon="o-arrow-path" tooltip-bottom="On progress" class="shadow-xs border border-slate-200" color="text-yellow-500" />
        </div>
